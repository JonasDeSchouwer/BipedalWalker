...
def run_and_save_episode(policy: bpPNet, epoch, mem: Memory):
...
def record_episode(policy: bpPNet, path, sigma=0):
...
def train_qmodel(q_func: bpQNet, q_target: bpQNet, p_target: bpPNet):
